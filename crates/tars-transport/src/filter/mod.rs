...
pub struct Message {
    ...
    pub hash_code: u32,
    /// Hash type
    pub hash_type: tars_util::selector::HashType,
    /// Is hash-based call
    pub is_hash: bool,
}
...
impl Message {
    pub fn new() -> Self {
        Self {
            ...
            status: 0,
            hash_code: 0,
            hash_type: tars_util::selector::HashType::ModHash,
            is_hash: false,
        }
    }
...
impl tars_util::selector::Message for Message {
    fn hash_code(&self) -> u32 {
        self.hash_code
    }

    fn hash_type(&self) -> tars_util::selector::HashType {
        self.hash_type
    }
