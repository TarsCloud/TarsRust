...
impl RequestPacket {
    ...
    pub fn new() -> Self {
        Self {
            i_version: tars_core::consts::TARS_VERSION,
            c_packet_type: tars_core::consts::TARS_NORMAL,
            i_message_type: 0,
            i_request_id: 0,
            s_servant_name: String::new(),
            s_func_name: String::new(),
            s_buffer: Vec::new(),
            i_timeout: tars_core::consts::DEFAULT_ASYNC_TIMEOUT as i32,
            context: HashMap::new(),
            status: HashMap::new(),
        }
    }
    ...
    pub fn is_oneway(&self) -> bool {
        self.c_packet_type == tars_core::consts::TARS_ONEWAY
    }
...
impl ResponsePacket {
    ...
    pub fn success(request_id: i32, buffer: Vec<u8>) -> Self {
        Self {
            ...
            i_message_type: 0,
            i_ret: tars_core::consts::TARS_SERVER_SUCCESS,
            s_buffer: buffer,
            status: HashMap::new(),
            s_result_desc: String::new(),
            context: HashMap::new(),
    ...
    pub fn timeout(request_id: i32) -> Self {
        Self::error(
            request_id,
            tars_core::consts::TARS_SERVER_QUEUE_TIMEOUT,
    ...
    pub fn is_success(&self) -> bool {
        self.i_ret == tars_core::consts::TARS_SERVER_SUCCESS
    }
...
mod tests {
    ...
    fn test_request_packet_oneway() {
        ...
        req.c_packet_type = tars_core::consts::TARS_ONEWAY;
        assert!(req.is_oneway());
    }
    ...
    fn test_request_packet_message_type() {
        let mut req = RequestPacket::new();
        assert!(!req.has_message_type(tars_core::consts::TARS_MESSAGE_TYPE_DYED));

        req.add_message_type(tars_core::consts::TARS_MESSAGE_TYPE_DYED);
        assert!(req.has_message_type(tars_core::consts::TARS_MESSAGE_TYPE_DYED));
        assert!(!req.has_message_type(tars_core::consts::TARS_MESSAGE_TYPE_TRACE));

        req.add_message_type(tars_core::consts::TARS_MESSAGE_TYPE_TRACE);
        assert!(req.has_message_type(tars_core::consts::TARS_MESSAGE_TYPE_DYED));
        assert!(req.has_message_type(tars_core::consts::TARS_MESSAGE_TYPE_TRACE));
    }
    ...
    fn test_response_packet_timeout() {
        ...
        assert!(!rsp.is_success());
        assert_eq!(rsp.i_ret, tars_core::consts::TARS_SERVER_QUEUE_TIMEOUT);
    }
}
